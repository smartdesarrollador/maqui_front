export const environment = {
  ...
  apiListarDestacadosProducto:
    'https://apimaquimotora.enfocussoluciones.pe/api/productos/destacados',
  apiUrl3Producto:
  ...
  apiUrlEmailContacto:
    'https://apimaquimotora.enfocussoluciones.pe/api/contacto',
  /* /3.- ENVIO-CORREO-V1-P2 */
  apiListarFilesTestimonio:
    'https://apimaquimotora.enfocussoluciones.pe/api/testimonios',

  postsUrl: 'https://apimaquimotora.enfocussoluciones.pe/api/posts', // Endpoint para posts
  categoriesUrl: 'https://apimaquimotora.enfocussoluciones.pe/api/categories', // Endpoint para categorías
  tagsUrl: 'https://apimaquimotora.enfocussoluciones.pe/api/tags', // Endpoint para tags
  commentsUrl: 'https://apimaquimotora.enfocussoluciones.pe/api/comments', // Endpoint para comentarios
  usersUrl: 'https://apimaquimotora.enfocussoluciones.pe/api/users', // Endpoint para usuarios
  /* componente1 */
  dominio: 'https://apimaquimotora.enfocussoluciones.pe',
  apiBaseUrl: 'https://apimaquimotora.enfocussoluciones.pe/api', // URL base para la API de Laravel
  endpoints: {
